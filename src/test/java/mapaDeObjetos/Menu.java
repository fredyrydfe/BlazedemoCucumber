...
public class Menu {
	...
	public static void ingresarALaOpcionDePropuestas() throws InterruptedException, IOException {
		...
		WebElement elemento = driver
				.findElement(By.xpath("//*[@id=\"mCSB_2_container\"]/ul/li[3]/a/span[2]"));
	...
	public static void ingresarALaOpcionDeNuevaSalud() throws IOException {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		WebElement elemento = driver
				.findElement(By.linkText("Nueva SALUD"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", elemento);
	}
	...
	public static void ingresarALaOpcionDeNuevaVida() throws IOException {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		WebElement elemento = driver
				.findElement(By.linkText("Nueva Vida"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", elemento);
	}
	...
	public static void ingresarAlaPropuestaConElUsuarioTecnico() {
		WebElement elemento = driver
				.findElement(By.xpath("//*[@id=\"mCSB_2_container\"]/ul/li[3]/ul/li/ul/li/a/span"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", elemento);
	}

	public static void ingresarALaPrimeraVersionDeLaPropuesta() {
		driver.findElement(By.xpath("//*[@id=\"mCSB_2_container\"]/ul/li[3]/ul/li[3]/ul/li/ul[1]/li[2]/ul/li/a/span")).click();
	}
	
	public static void ingresarALaPrimeraVersionDeLaPropuestaConElUsuarioTecnico() {
		driver.findElement(By.xpath("//*[@id=\"mCSB_2_container\"]/ul/li[3]/ul/li/ul/li/ul[1]/li[2]/ul/li/a/span")).click();
	}

	public static void ingresarALaOpcionDeConceptualizacion() {
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		WebElement elemento = driver
				.findElement(By.linkText("Conceptualización"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].click();", elemento);
	}

	public static void ingresarALaSegundaVersionDeLaPropuestaConElUsuarioTecnico() {
		driver.findElement(By.xpath("//*[@id=\"mCSB_2_container\"]/ul/li[3]/ul/li/ul/li/ul[1]/li[2]/ul/li[2]/a/span")).click();
	}

	public static void ingresarALaSegundaVersionDeLaPropuesta() {
		driver.findElement(By.xpath("//*[@id=\"mCSB_2_container\"]/ul/li[3]/ul/li[3]/ul/li/ul[1]/li[2]/ul/li[2]/a/span")).click();
	}
